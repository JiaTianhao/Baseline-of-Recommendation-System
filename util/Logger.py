...
def _create_logger():
    config = ConfigParser()
    print(os.path.exists("../NeuRec.properties"))
    config.read("C:\pycharm\\NeuRec-master\\NeuRec.propertiesNeuRec.properties")
    section=config.sections()
    print(section)
    lib_config = OrderedDict(config.items("default"))
